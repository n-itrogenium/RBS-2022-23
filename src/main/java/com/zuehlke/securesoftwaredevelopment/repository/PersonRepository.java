...
public class PersonRepository {
    ...
    public List<Person> getAll() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.info("Persons successfully fetched");
        } catch (SQLException e) {
            e.printStackTrace();
            LOG.warn("Persons fetch failed", e);
        }
        return personList;
    }
    ...
    public List<Person> search(String searchTerm) throws SQLException {
        ...
        LOG.info("Persons search successful");
        return personList;
    }
    ...
    public Person get(String personId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            e.printStackTrace();
            LOG.warn("Person " + personId + " fetch failed", e);
        }
        return null;
    }
    ...
    public void delete(int personId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            e.printStackTrace();
            AuditLogger.getAuditLogger(PersonRepository.class).audit("Deleting person " + personId +
                    " by user '" + SecurityUtil.getCurrentUser().getUsername()+ "' failed");
        }
        AuditLogger.getAuditLogger(PersonRepository.class).audit("Person " + personId +
                " deleted by user '" + SecurityUtil.getCurrentUser().getUsername());
    }
    ...
    private Person createPersonFromResultSet(ResultSet rs) throws SQLException {
        ...
        LOG.info("Person " + id + " successfully fetched");
    ...
    public void update(Person personUpdate) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            e.printStackTrace();
            AuditLogger.getAuditLogger(PersonRepository.class).audit("Updating person " + personUpdate.getId() +
                    " by user '" + SecurityUtil.getCurrentUser().getUsername()+ "' failed");
        }
        AuditLogger.getAuditLogger(PersonRepository.class).audit("Person " + personUpdate.getId() +
                " updated by user '" + SecurityUtil.getCurrentUser().getUsername());
    }
}
