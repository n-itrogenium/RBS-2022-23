...
public class RatingRepository {
    ...
    public void createOrUpdate(Rating rating) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.info("Creating or updating rating for movie " + rating.getMovieId() + " successful");
        } catch (SQLException e) {
            e.printStackTrace();
            LOG.warn("Creating or updating rating for movie " + rating.getMovieId() + " failed", e);
        }
    }
    ...
    public List<Rating> getAll(String movieId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.info("Ratings for movie " + movieId + " successfully fetched");
        } catch (SQLException e) {
            e.printStackTrace();
            LOG.warn("Ratings for movie " + movieId + " fetch failed", e);
        }
        return ratingList;
    }
}
